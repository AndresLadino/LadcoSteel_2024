                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="nombre" id="nombre"
                            ...
                            placeholder="Pepito" value="{{$cliente->nombre}}" required>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="apellido"
                        ...
                        <input type="text" name="apellido" id="apellido"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Perez" value="{{$cliente->apellido}}" required>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="telefono"
                        ...
                        <input type="number" name="teléfono" id="teléfono"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="3120000000" value="{{$cliente->teléfono}}" required>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="empresa"
                        ...
                        <input type="text" name="empresa" id="empresa"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Empresa a la que pertenece el cliente" value="{{$cliente->empresa}}" required>
                    </div>
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <input type="mail" name="correo" id="correo"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="ejemplo@compania.com" value="{{$cliente->correo}}" required>
                    </div>
