...
@section('content')
    <div class="main">
        <div class="font-bold text-4xl stroke-slate-500 pl-7" style="position: absolute; top: 18%; left: 0; text-shadow:-1.2px -1.2px 0 #709abf,           1.2px -1.2px 0 #709abf,         -1.2px 1.2px 0 #709abf,          1.2px 1.2px 0 #709abf;  color: white; width: 100%; padding: 10px;">

            <p class="px-32">No hemos encontrado tu pedido. Comunícate con nosotros si crees que es un error.</p>
        </div>
        <div>
