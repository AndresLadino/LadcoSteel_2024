...
<nav class="bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1633886038251-66242d6cf688?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MTJ8fHxlbnwwfHx8fHw%3D&w=1000&q=80')]  bg-blend-multiply text-lg shadow-lg	" >
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
      <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li>
          <a href="/nosotros" class="block py-2 pl-3 pr-4 text-amber-300 rounded hover:bg-amber-500 md:hover:bg-transparent md:hover:text-amber-500 md:p-0 font-normal">Nosotros</a>
        </li>
        <li>
        ...
        <li>
          <a href="/contacto" class="block py-2 pl-3 pr-4 text-amber-300 rounded hover:bg-amber-500 md:hover:bg-transparent md:hover:text-amber-500 md:p-0 font-normal">Contáctenos</a>
        </li>
      </ul>
    </div>
    </div>
