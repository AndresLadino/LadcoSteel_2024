        ...
        <nav
            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex items-center md:order-2">
                    ...
                    <!-- Dropdown lenguaje -->
                    <div class="z-50 hidden my-4 text-base list-none bg-neutral-900 divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700"
                        id="language-dropdown-menu">
                        <ul class="py-2 font-medium" role="none">
                            <li>
                                <a href="{{ url('locale/es') }}"
                                    class="block px-4 py-2 text-sm text-amber-300 hover:bg-neutral-950 dark:text-gray-400 dark:hover:bg-neutral-600 dark:hover:text-white"
                                    role="menuitem">
                    ...
                    <a href="/login">
                        <button type="button"
                        class="inline-flex items-center font-medium justify-center px-4 py-2 text-lg text-amber-300 rounded-lg cursor-pointer hover:bg-neutral-600">
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="currentColor" viewBox="0 0 32.000000 32.000000"
                            preserveAspectRatio="xMidYMid meet">
...
"
                                ...
                                <ul class="py-2 text-lg text-gray-700 dark:text-gray-400 "
                                    ...
                                    <li aria-labelledby="dropdownNavbarLink">
                                        ...
                                        <div id="doubleDropdown"
                                            ...
                                            <ul class="py-2 text-lg text-gray-700 dark:text-gray-200 md:bg-neutral-950"
            ...
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-slate-300 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="/nosotros" class="hover:underline">Historia</a>
                            </li>
                            <li>
                                <a href="/noticias
    " class="hover:underline">Noticias
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-slate-300 sm:text-center dark:text-gray-400">© 2023 <a href=""
                ...
                <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                    ...
                    <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
                            <path
