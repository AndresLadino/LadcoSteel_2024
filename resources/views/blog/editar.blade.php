            ...
            <form action="{{ route('blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-6 gap-6 overflow-y-auto">
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <input type="text" name="titulo" value="{{ $blog->titulo }}" id="titulo"
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <textarea id="parrafoPrincipal" value="" name="parrafoPrincipal" rows="4"
                            ...
                            placeholder="Escriba acá el primer párrafo">{{ $blog->parrafoPrincipal }}</textarea>
                    </div>
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <textarea id="parrafoSecundario" value="" name="parrafoSecundario" rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Escriba acá el segundo párrafo">{{ $blog->parrafoSecundario }}</textarea>
                    </div>
                    <div class="col-span-2 sm:col-span-2">
                        ...
                        <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="user_avatar_help">Será la
                            imagen que aparezca de fondo en el título de la página</div>
                    </div>
                    <div class="col-span-2 sm:col-span-2">
