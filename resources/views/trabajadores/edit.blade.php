        ...
        <div class="flex items-start border-b shadow-lg justify-between p-5 dark:border-gray-700">
            <h1
                ...
                <span class="underline underline-offset-3 decoration-8 decoration-amber-400 dark:decoration-blue-600">Editar
                    información para trabajador
                </span>
            </h1>

        </div>
        <p class="text-gray-500 dark:text-gray-400 mx-5 mt-10">Los campos marcados con * son obligatorios, de no ser llenados
            no se
            podrá crear el registro.</p>
        <!-- Modal body -->
        <div class="p-6 space-y-6">

            <form action="/trabajador/{{ $trabajador->id }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="nombre_1" id="nombre_1"
                                    ...
                                    placeholder="Primer nombre" value="{{ $trabajador->nombre_1 }}" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="nombre_2"
                                ...
                                <input type="text" name="nombre_2" id="nombre_2"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Segundo nombre" value="{{ $trabajador->nombre_2 }}">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="apellido_1" id="apellido_1"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Primer apellido" value="{{ $trabajador->apellido_1 }}" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="apellido_2" id="apellido_2"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Segundo Apellido" value="{{ $trabajador->apellido_2 }}" required>
                            </div>
                            <!--Segunda fila-->
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <select id="tipo_documento" name="tipo_documento" value="{{ $trabajador->tipo_cedula }}"
                            ...
                            <div class="col-span-6 sm:col-span-2"><!--acomodando los inputs-->
                                <label for="cedula"
                                    ...
                                    <span class="text-red-700 font-extrabold">*</span> </label>
                                <input type="number" name="cedula" id="cedula" value="{{ $trabajador->cedula }}"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <div class="relative max-w-sm">
                                    ...
                                    <input datepicker name="fecha_nac" id="fecha_nac"
                                        value="{{ $trabajador->fecha_nac }}" type="date"
                            ...
                            <div class="col-span-6 sm:col-span-1">
                                ...
                                <select id="sangre" name="sangre"
                                    ...
                                    <option value="A+" {{ $trabajador->tipo_sangre === 'A+' ? 'selected' : '' }}>A+
                                    </option>
                                    <option value="A-" {{ $trabajador->tipo_sangre === 'A-' ? 'selected' : '' }}>A-
                                    </option>
                                    <option value="B+" {{ $trabajador->tipo_sangre === 'B+' ? 'selected' : '' }}>B+
                                    </option>
                                    <option value="B-" {{ $trabajador->tipo_sangre === 'B-' ? 'selected' : '' }}>B-
                                    </option>
                                    <option value="AB+" {{ $trabajador->tipo_sangre === 'AB+' ? 'selected' : '' }}>AB+
                                    </option>
                                    <option value="AB-" {{ $trabajador->tipo_sangre === 'AB-' ? 'selected' : '' }}>AB-
                                    </option>
                                    <option value="O+" {{ $trabajador->tipo_sangre === 'O+' ? 'selected' : '' }}>O+
                                    </option>
                                    <option value="O-" {{ $trabajador->tipo_sangre === 'O-' ? 'selected' : '' }}>O-
                                    </option>
                                </select>
                            ...
                            <div class="col-span-6 sm:col-span-1">
                                ...
                                <select name="sexo" id="sexo"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option disabled>Seleccione</option>
                                    <option value="Hombre" {{ $trabajador->sexo === 'Hombre' ? 'selected' : '' }}>Hombre
                                    </option>
                                    <option value="Mujer" {{ $trabajador->sexo === 'Mujer' ? 'selected' : '' }}>Mujer
                                    </option>
                                    <option value="Otro" {{ $trabajador->sexo === 'Otro' ? 'selected' : '' }}>Otro
                                    </option>
                                </select>
                            </div>
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input type="email" name="correo" id="correo"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="ejemplo@ejemplo.com" value="{{ $trabajador->correo_electronico }}"
                                    required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="number" maxlength="10" name="telefono_1" id="telefono_1"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="3100000000" value="{{ $trabajador->telefono }}" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="direccion"
                                ...
                                <input type="text" name="direccion" id="direccion"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Dirección de residencia" value="{{ $trabajador->direccion }}" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="barrio"
                                ...
                                <input type="text" name="barrio" id="barrio"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Barrio en el que reside" value="{{ $trabajador->barrio }}" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="localidad"
                                ...
                                <input type="text" name="localidad" id="localidad"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Localidad en la que reside" value="{{ $trabajador->localidad }}"
                                    required>
                            </div>
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="cargo" id="cargo"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="El cargo que tiene" value="{{ $trabajador->cargo }}" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="salario"
                                ...
                                <input type="text" name="salario" id="salario"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="El salario que recibe" value="{{ $trabajador->salario }}" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="salario_neto" id="salario_neto"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="El salario neto que tiene" value="{{ $trabajador->salario_neto }}"
                                    required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="contrato"
                                ...
                                <input type="text" name="contrato" id="contrato"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Tipo de contrato" value="{{ $trabajador->contrato }}" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative max-w-sm">
                                    ...
                                    <input id="fecha_ingreso" name="fecha_ingreso" type="date"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Seleccionar fecha" value="{{ $trabajador->fecha_ingreso }}">
                                </div>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="eps" id="eps"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="EPS a la cual está afiliado" value="{{ $trabajador->eps }}">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="fondo_pensiones" id="fondo_pensiones"
                                    ...
                                    value="{{ $trabajador->fondo_pensiones }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input type="text" name="nombre_eme_1" id="nombre_eme_1"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Nombre completo" value="{{ $trabajador->nombre_emergencia_1 }}">
                            </div>
                            <div class="col-span-6 sm:col-span-4">
                                <label for="tel_eme_1"
                                ...
                                <input type="text" name="tel_eme_1" id="tel_eme_1"
                                    ...
                                    value="{{ $trabajador->telefono_emergencia_1 }}">
                            </div>
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input type="text" name="parentezco_eme_1" id="parentezco_eme_1"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Parentezco" value="{{ $trabajador->parentezco_1 }}">
                            </div>
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input type="text" name="nombre_eme_2" id="nombre_eme_2"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Nombre completo" value="{{ $trabajador->nombre_emergencia_2 }}">
                            </div>
                            <div class="col-span-6 sm:col-span-4">
                                <label for="tel_eme_2"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Telefono</label>
                                <input type="text" name="tel_eme_2" id="tel_eme_2"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Telefono de la persona"
                                    value="{{ $trabajador->telefono_emergencia_2 }}">
                            </div>
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input type="text" name="parentezco_eme_2" id="parentezco_eme_2"
                                    class="form-field shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Parentezco" value="{{ $trabajador->parentezco_2 }}">
                            </div>
                        </div>
                    </div>
                </div>
